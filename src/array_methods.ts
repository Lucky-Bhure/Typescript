...
const names: string[] = Array.of("Lucky","Krushnarao","Bhure");
...
const doubleNumber: number[] = numberArray.map((currVal: number) => currVal*2);
console.log(doubleNumber);

// 2: Converting numbers to strings
console.log("Number String: ");
const numberString: string[] = numberArray.map((currVal: number) => currVal.toString());
...
const evenNumber: number[] = numberArray.filter((currVal: number) => currVal%2 == 0);
console.log(evenNumber);

// 2: Filtering numbers greater than 3
console.log("Number greater than 3: ");
const greaterNumber: number[] = numberArray.filter((currVal: number) => currVal > 3);
